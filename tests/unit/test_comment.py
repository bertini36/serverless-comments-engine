...
def test_email_is_not_empty_validation():
    with pytest.raises(InvalidDataError) as e:
        Comment(post_slug='dummy', name='John', email='', text='Ouh mama')
...
def test_email_is_not_an_email_validation():
    with pytest.raises(InvalidDataError) as e:
        Comment(post_slug='dummy', name='John', email='john', text='Ouh mama')
...
def test_text_is_not_empty_validation():
    with pytest.raises(InvalidDataError) as e:
        Comment(post_slug='dummy', name='John', email='john@doe.com', text='')
...
def test_comment_seralization():
    comment = Comment(
        post_slug='dummy', name='John', email='john@doe.com', text='Ouh mama'
    )
...
def test_comments_sort():
    comment_1 = Comment(
        post_slug='dummy1', name='John', email='john@doe.com', text='Ouh mama'
    )
    comment_2 = Comment(
        post_slug='dummy2', name='John', email='john@doe.com', text='Ouh mama'
    )
